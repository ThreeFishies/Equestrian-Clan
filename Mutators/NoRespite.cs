                ...
                case 0: //ring 1
                    {
                        ...
                        list.Shuffle<CharacterData>(RngId.Spawning);
                ...
                case 1: //ring 2
                    {
                        ...
                        list2.Shuffle<CharacterData>(RngId.Spawning);
...
namespace Equestrian.HarmonyPatches
{
    ...
    public static class NoRespitePatch2
    {
        ...
        public static void Postfix(ref List<CharacterData> __result, ref SpawnGroupData __instance)
        {
            ...
            if (__result.Count != 4) { return; }

            if (currentLevel > 0) { NewSpawnPattern = true; }

            for (int jj = 0; jj < 4; jj++)
            {
                HellforgedSpawnPattern[jj] = (jj < currentLevel);
            }

            HellforgedSpawnPattern.Shuffle<bool>(RngId.Spawning);
