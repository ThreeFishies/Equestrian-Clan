...
{
    public static class DesignedByCommittee_spChallenge
    {
        public static SpChallengeData data;
        public static string ID = Ponies.GUID + "_DesignedByCommittee_spChallenge";
        public static string iconPath = Path.Combine(Path.GetDirectoryName(Ponies.Instance.Info.Location), "Mutators/Sprite", "SPC_DesignedByCommittee.png");
        ...
        public static void BuildAndRegister()
        {
            ...
            {
                BureaucracyMutator.bureaucracyMutatorData,
                ProviderManager.SaveManager.GetAllGameData().FindMutatorData("50234273-58a2-48dd-8e99-b8fdecb3828f"), //Additional Starting Cards
                GroupHugMutator.groupHugMutatorData
            };

            AccessTools.Field(typeof(GameData), "id").SetValue(data, ID);
            AccessTools.Field(typeof(SpChallengeData), "nameKey").SetValue(data, "Pony_spChallenge_DesignedByCommittee_Name_Key");
            AccessTools.Field(typeof(SpChallengeData), "descriptionKey").SetValue(data, "Pony_spChallenge_DesignedByCommittee_Description_Key");
