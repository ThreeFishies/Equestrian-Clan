...
public sealed class CustomEffectFreezeRandomFilteredCard : CardEffectBase, ICardEffectStatuslessTooltip
{
	...
	public override bool TestEffect(CardEffectState cardEffectState, CardEffectParams cardEffectParams)
	{
		...
		CustomEffectFreezeRandomFilteredCard.FilterCards(hand, cardEffectState, cardEffectParams);
		return hand.Count > 0;
	}
	...
	public override IEnumerator ApplyEffect(CardEffectState cardEffectState, CardEffectParams cardEffectParams)
	{
		...
		CardState cardState = hand[index];
