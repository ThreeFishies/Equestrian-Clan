...
namespace CustomEffects
{
	...
	public sealed class CustomMutatorEffectAddUpgradeToAllCards : RelicEffectBase, IAddStartingUpgradeToCardDrafts, IRelicEffect, ICardModifierRelicEffect
	{
		...
		public bool ApplyCardStateModifiers(CardState cardState, SaveManager saveManager, CardManager cardManager, RelicManager relicManager) 
		{
			...
			//if (cardState.GetCardStateModifiers().HasUpgrade(cardUpgradeState))
			//{
			//	return false;
			//}

            //for (int ii = 0; ii < cardState.GetEffects().Count; ii++)
            //{
            //    if (cardState.GetEffects()[ii].GetType() == typeof(CustomEffectKablooie))
            //    {
            //        return false;
            //    }
            //}
		...
		*/
		...
		public void UpgradeCard(CardDrawnRelicEffectParams relicEffectParams)
		{
            ...
            //if (relicEffectParams.cardState.GetCardStateModifiers().HasUpgrade(cardUpgradeState))
            //{
            //    return;
            //}

			//for (int ii = 0; ii < relicEffectParams.cardState.GetEffects().Count; ii++) 
			//{
			//	if (relicEffectParams.cardState.GetEffects()[ii].GetType() == typeof(CustomEffectKablooie)) 
			//	{
			//		return;
			//	}
			//}
