...
namespace CustomEffects
{
	internal class StatusEffectMale : StatusEffectState
	{
		...
		{
			new Trainworks.BuildersV2.StatusEffectDataBuilder
			{
				StatusEffectStateType = typeof(StatusEffectMale),
				StatusID = "male",
				DisplayCategory = StatusEffectData.DisplayCategory.Persistent,
				IconPath = "ClanAssets/Male.png",
				TooltipIconPath = "ClanAssets/StatusSmall/Male.png",
	...
	internal class StatusEffectFemale : StatusEffectState
	{
		...
		public static void Make()
		{
			new Trainworks.BuildersV2.StatusEffectDataBuilder
			{
				StatusEffectStateType = typeof(StatusEffectFemale),
				StatusID = "female",
				DisplayCategory = StatusEffectData.DisplayCategory.Persistent,
				IconPath = "ClanAssets/Female.png",
                TooltipIconPath = "ClanAssets/StatusSmall/Female.png",
                ShowStackCount = false,
				IsStackable = false,
				TriggerStage = StatusEffectData.TriggerStage.None,
			}.Build();
	...
	internal class StatusEffectGenderless : StatusEffectState
	{
		...
		public static void Make()
		{
			new Trainworks.BuildersV2.StatusEffectDataBuilder
			{
				StatusEffectStateType = typeof(StatusEffectGenderless),
				StatusID = "genderless",
				DisplayCategory = StatusEffectData.DisplayCategory.Persistent,
				IconPath = "ClanAssets/Genderless.png",
                TooltipIconPath = "ClanAssets/StatusSmall/Genderless.png",
                ShowStackCount = false,
				IsStackable = false,
				TriggerStage = StatusEffectData.TriggerStage.None,
			}.Build();
	...
	internal class StatusEffectUndefined : StatusEffectState
	{
		...
		public static void Make()
		{
			new Trainworks.BuildersV2.StatusEffectDataBuilder
			{
				StatusEffectStateType = typeof(StatusEffectUndefined),
				StatusID = "undefined",
				DisplayCategory = StatusEffectData.DisplayCategory.Persistent,
				IconPath = "ClanAssets/Undefined.png",
                TooltipIconPath = "ClanAssets/StatusSmall/Undefined.png",
                ShowStackCount = false,
				IsStackable = false,
				TriggerStage = StatusEffectData.TriggerStage.None,
			}.Build();
