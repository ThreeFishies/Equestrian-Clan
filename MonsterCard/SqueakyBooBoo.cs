            ...
            CharacterData SqueakyBooBooCharacterData = new CharacterDataBuilder
            {
                ...
                CharacterChatterData = new CharacterChatterDataBuilder() 
                {
                    ...
                    characterAddedExpressionKeys = new List<string>() 
                    {
                        ...
                        "Pony_Unit_SqueakyBooBoo_Chatter_Added_2_Key",
                        "Pony_Unit_SqueakyBooBoo_Chatter_Added_3_Key",
                        "Pony_Unit_SqueakyBooBoo_Chatter_Added_4_Key"
                    },

                    characterAttackingExpressionKeys = new List<string>() 
                    {
                        "Pony_Unit_SqueakyBooBoo_Chatter_Attacking_1_Key",
                        "Pony_Unit_SqueakyBooBoo_Chatter_Attacking_2_Key",
                        "Pony_Unit_SqueakyBooBoo_Chatter_Attacking_3_Key",
                        "Pony_Unit_SqueakyBooBoo_Chatter_Attacking_4_Key"
                    },

                    characterSlayedExpressionKeys = new List<string>() 
                    {
                        "Pony_Unit_SqueakyBooBoo_Chatter_Slayed_1_Key",
                        "Pony_Unit_SqueakyBooBoo_Chatter_Slayed_2_Key",
                        "Pony_Unit_SqueakyBooBoo_Chatter_Slayed_3_Key",
                        "Pony_Unit_SqueakyBooBoo_Chatter_Slayed_4_Key"
                    },
                    ...
                    { 
                        ...
                        new CharacterChatterDataBuilder.CharacterTriggerDataChatterExpressionKeys()
                        {
                            Key = "Pony_Unit_SqueakyBooBoo_Chatter_Trigger_PostCombat_2_Key",
                            Trigger = CharacterTriggerData.Trigger.PostCombat
                        },
                        new CharacterChatterDataBuilder.CharacterTriggerDataChatterExpressionKeys()
                        {
                            Key = "Pony_Unit_SqueakyBooBoo_Chatter_Trigger_PostCombat_3_Key",
                            Trigger = CharacterTriggerData.Trigger.PostCombat
                        },
                        new CharacterChatterDataBuilder.CharacterTriggerDataChatterExpressionKeys()
                        {
                            Key = "Pony_Unit_SqueakyBooBoo_Chatter_Trigger_PostCombat_4_Key",
                            Trigger = CharacterTriggerData.Trigger.PostCombat
                        }
                    }
                }.Build(),
